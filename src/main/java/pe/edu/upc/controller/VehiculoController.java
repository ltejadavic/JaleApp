...
public class VehiculoController {
	...
	public String modifPre(Vehiculo vec) {

		this.setVehiculo(vec);
		return "vehiculoMod.xhtml";
	}

	public void modificar() {
		try {
			vService.update(this.vehiculo);
		} catch (Exception e) {
			System.out.println("Error al modificar en el controller de vehiculo");
		}
	}
